...
WIN_APPS='commander contacts mail news notepad player reader twitter viewer vk'
...
LINUX_APPS='commander contacts mail news notepad player reader twitter viewer vk'
...
ISO_APPS='commander contacts mail news notepad player reader twitter viewer vk'
