...
./melody.sh $INS $VOLUME 77 $DUR 73 $DUR 77 $DUR | csvmidi - > melody.midi && timidity -Ow melody.midi > /dev/null && mv melody.wav .melody-src.wav
...
./melody.sh 65 120 89 80 | csvmidi - > melody.midi && timidity -Ow melody.midi > /dev/null && mv melody.wav .high-src.wav
